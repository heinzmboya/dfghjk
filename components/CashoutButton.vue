...
<template>
  <button
    ref="BtnRef" z-10 bg-gray-600 hover:text-gray-300 font-bold px-2 py-1 rounded absolute flex @click="onCashOut"
    @mouseover="randomDirection"
  >
    <div i-fluent-emoji:money-with-wings w-5 h-5 mr-2 />
    CASH OUT
  </button>
</template>
